...
def test_battle_result_flow():
    ...
    print("\n[템플릿 확인]")
    templates = {
        "Victory 화면": victory_screen,
        "통계 버튼": battle_log_button,
        "데미지 기록 창": damage_report,
        "데미지 기록 확인 버튼": battle_log_confirm_button,
        "Victory 확인 버튼": confirm_button,
        "랭크 획득 창": rank_reward_screen,
        "랭크 획득 창 확인 버튼": rank_reward_confirm_button,
        "스테이지 맵": stage_map
    }
    ...
    matcher = TemplateMatcher(confidence=0.7)  # 신뢰도 조정
    # ============================================================
    # 2단계: 통계 버튼 찾기 및 클릭
    # ============================================================
    print("\n[2단계] 통계 버튼 찾기...")
    ...
    matcher = TemplateMatcher(confidence=0.5)  # 신뢰도 조정
    # ============================================================
