...
### PASS 기준:
   ...
   4. 전투 진입 UI 다중 조건 검증 성공
      아래 UI 요소 중 3개 중 2개 이상이 제한 시간 내 인식됨:
         battle_ui.png
         stage_info_ui.png
         pause_button.png
...
본 테스트의 목적은
“전투 진입 플로우가 UI 기준으로 정상 동작하는가” 이기 때문입니다.
---
...
> 🔎 **요약**
> 전투 중 코스트 값을 OCR로 읽는 시도를 진행했으나, Tesseract OCR의 게임 UI 인식 한계로 40% 정확도에 머물렀습니다.
   작은 크기의 장식 폰트, 주변 UI 간섭, 동적 이펙트 등으로 인해 요구 정확도(95%)를 충족하지 못했으며, 템플릿 매칭 방식도 30% 신뢰도로 실패하였습니다.
