...
### GUI 동작 흐름
0. 두번째 또는 마지막 전투에 수행하는것을 권장드립니다.(테스트 도중에 전투가 끝날 수 있습니다.)
1. 전투 시작 후 대기
...
그레이스케일 변환, 이진화, 노이즈 제거, 스케일 업 등의 전처리와 다중 PSM 모드(7, 8, 6, 13)를 적용했으나 인식 정확도 40%에 머물렀습니다.:
...
2-5까지 4개의 숫자 템플릿 이미지를 준비하여 매칭을 시도했으나, 폰트 렌더링 차이와 화면 밝기/대비 변동으로 인해 30% 신뢰도에 그쳤습니다.:
