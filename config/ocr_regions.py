...
BATTLE_COST_CURRENT_REGION = (1550, 1300, 1645, 1400)
...
# 최대 코스트 숫자 읽기
# 예: "10" 부분만 (필요시 조정)
BATTLE_COST_MAX_REGION = (1600, 1300, 1645, 1400)

# 코스트 게이지 영역 (픽셀 카운팅용)
# 면적 변화로 코스트 소모 검증 (숫자 읽기 대체)
# 2560x1440 해상도 기준
BATTLE_COST_GAUGE_REGION = (1550, 1300, 1645, 1400)
...
# 참고: 스킬 버튼 클릭 위치 및 스킬 코스트 OCR 영역은
#       config/skill_settings.py 파일에 정의되어 있습니다.
#       (SKILL_BUTTON_SLOT_1/2/3, SKILL_COST_SLOT_1/2/3)
